...
.. py:class:: SchemaManager(db_path = None)
   ...
   .. py:method:: initialize_schema_tracking(conn)
   ...
   .. py:method:: create_all_twin_tables(conn)
   ...
   .. py:method:: create_all_sqlmodel_tables()
   ...
   .. py:method:: get_table_info(table_name)
   ...
   .. py:method:: validate_against_ontology()
