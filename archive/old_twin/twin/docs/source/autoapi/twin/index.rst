...
.. toctree::
   ...
   /autoapi/twin/actionable_parameters/index
   /autoapi/twin/config_loader/index
   /autoapi/twin/config_manager/index
...
.. py:class:: SimulationRunner(db_path = None, generator_path = None, generator_version = None, verbose = False)
   ...
   .. py:method:: run_simulation(parameters, parent_run_id = None, seed = None, duration_days = 7, notes = None)
   ...
   .. py:method:: create_baseline(seed = 42, duration_days = 7, notes = None)
   ...
   .. py:method:: run_monte_carlo_simulation(parameters, uncertainty_ranges, n_simulations = 100, duration_days = 7, parent_run_id = None, notes = None)
   ...
   .. py:method:: compare_runs(run_ids)
   ...
   .. py:method:: get_run_lineage(run_id)
...
.. py:class:: ActionableParameters(config_path = None)
   ...
   .. py:method:: set_value(parameter_name, value)
   ...
   .. py:method:: get_value(parameter_name)
   ...
   .. py:method:: reset(parameter_name = None)
   ...
   .. py:method:: get_normalized_vector()
   ...
   .. py:method:: set_from_normalized_vector(vector)
   ...
   .. py:method:: get_bounds_for_optimization()
...
.. py:class:: ActionableParameter
   ...
   .. py:method:: denormalize(normalized)
...
.. py:class:: CostImpactCalculator(db_path = None, cost_params = None)
   ...
   .. py:method:: calculate_roi(baseline_run_id, improved_run_id, n_simulations = None, time_horizon_weeks = None, include_uncertainty = True)
   ...
   .. py:method:: calculate_scenario_impact(scenario, baseline_kpis, parameter_changes, n_simulations = 1000)
   ...
   .. py:method:: format_roi_report(roi_summary)
...
.. py:class:: SyncHealthMonitor(db_path = None)
   ...
   .. py:method:: init_sync_tables()

      Initialize synchronization metadata tables



   .. py:method:: update_sync_metadata(entity_id, entity_type, data = None, source_run_id = None, sync_interval_minutes = None)
   ...
   .. py:method:: get_sync_health(entity_id = None)
   ...
   .. py:method:: check_health_alerts(threshold_minutes = None)
   ...
   .. py:method:: get_sync_history(entity_id, hours = None)
   ...
   .. py:method:: cleanup_old_logs(days_to_keep = None)
   ...
   .. py:method:: export_health_report()
