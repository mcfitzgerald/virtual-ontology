...
.. autoapisummary::
   ...
   conf.autoapi_root
   conf.napoleon_google_docstring
   conf.napoleon_numpy_docstring
   conf.napoleon_include_init_with_doc
   conf.napoleon_include_private_with_doc
   conf.napoleon_include_special_with_doc
   conf.napoleon_use_admonition_for_examples
   conf.napoleon_use_admonition_for_notes
   conf.napoleon_use_admonition_for_references
   conf.napoleon_use_ivar
   conf.napoleon_use_param
   conf.napoleon_use_rtype
   conf.napoleon_preprocess_types
   conf.napoleon_type_aliases
   conf.napoleon_attr_annotations
   conf.autodoc_default_options
   conf.autodoc_typehints
   conf.autodoc_typehints_format
   ...
   conf.html_show_sphinx
   conf.html_show_copyright
   ...
   conf.coverage_show_missing_items
...
.. py:data:: database_root

.. py:data:: project
   :value: 'Virtual Ontology Database'


.. py:data:: copyright
   :value: '2025, Virtual Ontology Team'


.. py:data:: author
   :value: 'Virtual Ontology Team'
...
.. py:data:: extensions
   :value: ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.viewcode', 'sphinx.ext.intersphinx',...
...
.. py:data:: autoapi_ignore
   :value: ['*/__pycache__/*', '*/test_*', '*/tests/*', '*.pyc', '*.pyo']
...
.. py:data:: napoleon_preprocess_types
   :value: True
...
.. py:data:: html_show_sourcelink
   :value: True


.. py:data:: html_show_sphinx
   :value: True


.. py:data:: html_show_copyright
   :value: True
...
.. py:data:: latex_documents
   :value: [('index', 'VirtualOntologyDatabase.tex', 'Virtual Ontology Database Documentation', 'Virtual...


.. py:data:: man_pages
   :value: [('index', 'virtualontologydatabase', 'Virtual Ontology Database Documentation', ['Virtual...
