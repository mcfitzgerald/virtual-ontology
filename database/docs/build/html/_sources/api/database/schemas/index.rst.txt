...
.. py:class:: SimulationRequest(/, **data)
...
.. py:class:: ExperimentRequest(/, **data)
...
.. py:class:: SimulationResponse(/, **data)
...
.. py:class:: ExperimentResponse(/, **data)
...
.. py:class:: RecommendationResponse(/, **data)
...
.. py:class:: ComparisonResponse(/, **data)
...
.. py:class:: SQLQueryResponse(/, **data)
...
.. py:class:: OperationResponse(/, **data)
...
.. py:class:: SimulationListResponse(/, **data)
...
.. py:class:: ExperimentListResponse(/, **data)
...
.. py:class:: PatternListResponse(/, **data)
...
.. py:class:: RecommendationListResponse(/, **data)
