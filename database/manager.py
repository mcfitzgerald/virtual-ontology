...
from database.models import HistoricalMESData, EquipmentConfig, ProductConfig
...
class TwinDatabaseManager:
    ...
    def __init__(
        self, db_path: Optional[Path] = None, ontology_path: Optional[Path] = None, manifest_dir: Optional[Path] = None
    ):
        # Database setup
        ...
        self._manifest_cache = {}  # type: ignore[var-annotated]
    ...
    def load_manifest(self, manifest_name: str) -> Dict[str, Any]:
        ...
        return self._manifest_cache[manifest_name]  # type: ignore[no-any-return]
            ...
            for eq_id, eq_data in equipment_manifest.get("equipment", {}).items():
                ...
                if existing:
                    ...
                    config = EquipmentConfig(
                        ...
                        failure_patterns_json=json.dumps(eq_data.get("failure_patterns", {})),
                        performance_by_product_json=json.dumps(eq_data.get("performance_by_product", {})),
                    )
                    session.add(config)
    ...
    def get_ontology_version(self) -> str:
        ...
        return ontology.get("metadata", {}).get("version", "1.0.0")  # type: ignore[no-any-return]
