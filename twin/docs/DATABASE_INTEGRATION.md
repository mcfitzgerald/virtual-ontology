...
The Virtual Twin system provides tight integration between the twin module, database layer, and API services. This guide covers the database management features, configuration storage, and integration patterns implemented in v1.3.0.

## Table of Contents

1. [Database Reset & Management](#database-reset--management)
...
The system provides a complete "nuke and rebuild" capability for resetting the database to a pristine state:
...
# Tests cover:
# - Pristine reset functionality
# - Config database storage
# - Ontology-schema alignment
# - API twin table access
...
#### 1. Stale Metadata After Reset
```bash
# Solution: Run pristine reset
python api/database_setup.py reset
```

#### 2. Config Files Still Being Created
```python
...
- [Database Schema](../../DATABASE_AND_API.md) - Detailed schema documentation
- [Ontology Specifications](../../ontology/) - Ontology YAML definitions
