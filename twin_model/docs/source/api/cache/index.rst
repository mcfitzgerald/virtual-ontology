...
.. py:class:: ObservableCache(cache_dir, max_size = 1000000, dtype_size = 1024)
   ...
   .. py:method:: read_event(global_index)
   ...
   .. py:method:: read_range(start_index, end_index)
   ...
   .. py:method:: query_events(event_type = None, primitive_id = None, start_time = None, end_time = None, limit = 1000)
