...
.. py:function:: identify_pareto_front(points: List[Dict[str, Any]]) -> List[Dict[str, Any]]

   Identify Pareto optimal points (non-dominated solutions)
   Assumes maximizing OEE and minimizing energy


.. py:function:: create_pareto_3d(run_ids: List[str], objectives: List[str] = ['oee', 'energy', 'quality'], db_path: str = 'data/mes_database.db') -> plotly.graph_objects.Figure
