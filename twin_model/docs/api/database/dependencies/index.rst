...
.. py:function:: get_db_manager(request: fastapi.Request) -> database.manager.TwinDatabaseManager

   Get database manager from app state


.. py:function:: get_session(manager: Annotated[database.manager.TwinDatabaseManager, Depends(get_db_manager)]) -> Generator[sqlmodel.Session, None, None]
...
.. py:function:: get_twin_run_repo(session: SessionDep) -> database.repositories.TwinRunRepository

   Get TwinRun repository instance


.. py:function:: get_simulation_data_repo(session: SessionDep) -> database.repositories.SimulationDataRepository

   Get SimulationData repository instance


.. py:function:: get_experiment_repo(session: SessionDep) -> database.repositories.ExperimentRepository

   Get Experiment repository instance


.. py:function:: get_pattern_repo(session: SessionDep) -> database.repositories.PatternRepository

   Get Pattern repository instance


.. py:function:: get_recommendation_repo(session: SessionDep) -> database.repositories.RecommendationRepository

   Get Recommendation repository instance


.. py:function:: get_kpi_repo(session: SessionDep) -> database.repositories.KPIRepository
