...
.. py:class:: PerformanceConfig
   ...
   .. py:method:: from_preset(preset: Union[ConfigPreset, str]) -> PerformanceConfig
      :classmethod:
   ...
   .. py:method:: from_json(path: Union[str, pathlib.Path]) -> PerformanceConfig
      :classmethod:
   ...
   .. py:method:: from_yaml(path: Union[str, pathlib.Path]) -> PerformanceConfig
      :classmethod:
   ...
   .. py:method:: to_json(path: Union[str, pathlib.Path]) -> None
   ...
   .. py:method:: to_yaml(path: Union[str, pathlib.Path]) -> None
   ...
   .. py:method:: estimate_memory_usage(num_primitives: int, simulation_days: int) -> Dict[str, float]
   ...
   .. py:method:: recommend_settings(num_primitives: int, simulation_days: int, available_memory_mb: float) -> PerformanceConfig
