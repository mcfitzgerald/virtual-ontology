...
from twin_model.primitives.source_flow import SourceFlow, ProductionOrder as SourceOrder
from twin_model.scheduling.production_scheduler import ProductionScheduler, ProductionOrder
    ...
    def _update_line_production(self, line_id: str, source: SourceFlow):
        ...
        if current_order and current_order.status == self.scheduler.OrderStatus.IN_PROGRESS:
            ...
            for equip_id in self.lines[line_id]:
                self.collector.update_production_order(
                    equip_id,
        ...
        for line_id, source in self.line_sources.items():
            ...
            if current_order:
                ...
                if source.current_order:
                    ...
                    self.scheduler.update_order_progress(
                        current_order.order_id,
                        good_units,
                        scrap_units
                    )
