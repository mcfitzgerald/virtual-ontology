...
class ProductManifest:
    ...
    def get_changeover_time(
        ...
        if (from_product_id in self.changeover_matrix_overrides and
            to_product_id in self.changeover_matrix_overrides[from_product_id]):
    ...
    def is_product_capable_on_line(
        self,
        product_id: str,
        line_id: str
    ) -> bool:
        ...
        for product in self.products.values():
            ...
            for line_id, compatibility in product.line_compatibility.items():
                if line_id not in summary['line_capabilities']:
                    summary['line_capabilities'][line_id] = {
                        'capable_products': 0,
                        'preferred_products': 0
                    }
