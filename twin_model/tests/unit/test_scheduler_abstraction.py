...
from twin_model.scheduling import (
    BaseScheduler,
    SchedulerConfig,
    ...
    def test_load_config_from_yaml(self):
        ...
        config_data = {
            ...
            'scheduling_constraints': {
                'horizon_hours': 168,
                'maintenance_windows': [
                    {'start_hour': 24, 'duration_hours': 2}
                ],
                'product_line_compatibility': {
                    'P1': ['1', '2']
                }
