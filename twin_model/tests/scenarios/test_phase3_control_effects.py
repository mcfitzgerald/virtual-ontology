...
def test_control_manager_initialization():
    ...
    control_mgr = ControlManager(ontology_path=ontology_path, mappings_path=mappings_path, settings_path=settings_path)
...
def test_control_to_parameter_mapping(control_mgr):
    ...
    print("   Low training (5 hours) effects:")
    ...
    print("   High training (40 hours) effects:")
...
def test_scenario_application(control_mgr):
    ...
    for scenario_name in scenarios:
        ...
        if success:
            ...
            print("  Estimated OEE components:")
...
def test_parameter_effects_manager():
    ...
    print("✓ Parameter effects manager initialized")
...
def test_control_effects_integration(control_mgr, effects_mgr):
    ...
    test_config = {"id": "TEST-EQUIP", "type": "EquipmentPrimitive", "base_rate": 60.0}

    updated_config = effects_mgr.apply_to_config(test_config, "EquipmentPrimitive")
...
def test_control_recommendations(control_mgr):
    ...
    print("  - line_speed_setting: 95%")
    print("  - operator_training_hours: 5")
    print("  - pm_schedule_compliance: 50%")
