...
class MESDataCollector:
    ...
    def _setup_default_products(self):
        ...
        self.product_info = {
            ...
            "SKU-1002": ProductInfo(
                product_id="SKU-1002", product_name="8oz Juice", standard_cost=0.25, sale_price=0.85, target_rate=475
            ),
            "SKU-2001": ProductInfo(
                product_id="SKU-2001", product_name="12oz Soda", standard_cost=0.20, sale_price=0.65, target_rate=475
            ),
            ...
            "SKU-3002": ProductInfo(
                product_id="SKU-3002", product_name="1L Juice", standard_cost=0.75, sale_price=2.50, target_rate=425
            ),
        }

    def register_equipment(self, equipment_id: str, equipment: BaseFlowPrimitive, equipment_type: str, line_id: str):
        ...
        """
        self.equipment_registry[equipment_id] = {"primitive": equipment, "type": equipment_type, "line_id": line_id}
    ...
    def update_production_order(self, equipment_id: str, order_id: str, product_id: str):
    ...
    def _calculate_interval_metrics(
        ...
        end_metrics["total_input"] - start_metrics["total_input"]
    ...
    def collect_current_data(self):
        ...
        for equipment_id, info in self.equipment_registry.items():
            ...
            good_units, scrap_units, availability, performance, quality = self._calculate_interval_metrics(
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "production": {
                ...
                / (df["GoodUnitsProduced"].sum() + df["ScrapUnitsProduced"].sum())
                * 100,
            },
            "oee": {
